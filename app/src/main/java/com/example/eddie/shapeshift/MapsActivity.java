...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        back2 = (ImageButton) findViewById(R.id.bn_back2);
    ...
    public void onClick(View v)
    {
        ...
        switch(v.getId())
        {
            ...
            case R.id.B_supermarket:
                ...
                getNearbyPlacesData.execute(dataTransfer);
                Toast.makeText(MapsActivity.this, "Showing Nearby Health Food Groceries", Toast.LENGTH_SHORT).show();
                /*
                break;
            case R.id.B_department_store:
                mMap.clear();
                String department_store = "department_store";
                url = getUrl(latitude, longitude, department_store);
                dataTransfer[0] = mMap;
                dataTransfer[1] = url;
    ...
    private String getUrl(double latitude , double longitude , String nearbyPlace)
    {
        ...
        googlePlaceUrl.append("&key="+"AIzaSyCFF1i1lsgu6zspl7s7MYXK8G7aMHq0IQA");
